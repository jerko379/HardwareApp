...
import hr.tvz.josipovic.hardwareapp.Security.domain.Authority;
import hr.tvz.josipovic.hardwareapp.Security.domain.User;
import hr.tvz.josipovic.hardwareapp.Security.user.ApplicationUser;
import hr.tvz.josipovic.hardwareapp.Security.user.UserAuthentication;
